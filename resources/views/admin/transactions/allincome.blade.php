                ...
                <div class="card card-secondary card-tabs">
                    ...
                    <div class="card-header p-0 pt-1">
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-bd-income-tab" data-toggle="pill" href="#custom-tabs-one-bd-income" role="tab" aria-controls="custom-tabs-one-bd-income" aria-selected="false">BD Income</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-ksa-income-tab" data-toggle="pill" href="#custom-tabs-one-ksa-income" role="tab" aria-controls="custom-tabs-one-ksa-income" aria-selected="false">KSA Income</a>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-bd-income" role="tabpanel" aria-labelledby="custom-tabs-one-bd-income-tab">
                                <div class="row mb-3">
                                    <form class="form-inline" role="form" method="POST" action="{{ route('admin.bdtincome.filter') }}">
                                        {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-ksa-income" role="tabpanel" aria-labelledby="custom-tabs-one-ksa-income-tab">
                                <div class="row mb-3">
...
<script>
    ...
    var bdurl = "{{URL::to('/admin/bdt-income')}}";
    var bdIncomeTBL = $('#bdIncomeTBL').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: bdurl,
    ...
    var ksaurl = "{{URL::to('/admin/ksa-income')}}";
    var ksaincomeTBL = $('#ksaIncomeTBL').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: ksaurl,
